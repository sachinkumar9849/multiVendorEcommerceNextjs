      ...
      <div className="border-b border-gray-600">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6">Subscribe to our newsletter and get exclusive deals & updates</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'Shop', 'Categories', 'New Arrivals', 'Best Sellers', 'Sale'].map((link) => (
                <li key={link}>
                  <a 
                    href="#" 
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-3">
                {[
                  ...
                  >
                    <Icon size={16} className="text-gray-300 group-hover:text-white" />
                  </a>
                ))}
              </div>
            </div>
